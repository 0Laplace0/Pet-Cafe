...
<html lang="en">
  ...
  <!-- Start Menu -->
  <div class="container">
    <div class="row mt-5 gx-lg-5" data-aos="fade-up">
      <div class="col-12 col-lg-6">
        <img src="{{ asset('asset/banner/menu01.png') }}"
            class="w-100 d-block rounded-5 shadow-lg" alt="menu01">
      </div>
      <div class="col-12 col-lg-6 mt-4 mt-lg-0">
        <img src="{{ asset('asset/banner/menu02.png') }}"
            class="w-100 d-block rounded-5 shadow-lg" alt="menu02">
      </div>
    </div>
  </div>
  <!-- End Menu -->
