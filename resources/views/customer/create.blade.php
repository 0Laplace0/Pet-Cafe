        ...
        <div class="col-sm-9">
            ...
            <form action="/customer/" method="post">
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="password" class="form-control" name="customer_password" required placeholder="Input Password"
                            minlength="4">
                        @if(isset($errors))
                        @if($errors->has('customer_password'))
                        <div class="text-danger"> {{ $errors->first('customer_password') }}</div>
                        @endif
                        @endif
                    </div>
                </div>
