        ...
        <div class="col-sm-12">
            ...
            <form action="/staff/{{ $id }}" method="post">
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="staff_fname" required placeholder="First name"
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="staff_lname" required placeholder="Last name"
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="tel" class="form-control" name="staff_tel" required placeholder="Phone 10 digit"
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="email" class="form-control" name="staff_email" required placeholder="Email"
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="staff_gender" required placeholder="Gender"
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-7">
                        <textarea name="staff_address" class="form-control" rows="4" required
                            placeholder="Address">{{ old('staff_address') }}</textarea>
                        @if(isset($errors))
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="staff_position" required placeholder="Position"
